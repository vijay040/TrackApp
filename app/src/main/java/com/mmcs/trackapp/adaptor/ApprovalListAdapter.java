...
/**
 * Created by Lenovo on 12-10-2018.
 */
...
public class ApprovalListAdapter extends BaseAdapter {
    ...
    public ApprovalListAdapter(Activity context, ArrayList<ExpenseModel> list) {
        this.list = list;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.activity_approval_list_item, null);
        }
