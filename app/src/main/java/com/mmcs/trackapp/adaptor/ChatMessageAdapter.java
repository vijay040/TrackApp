...
import com.mmcs.trackapp.model.ChatMessageModel;
...
public class ChatMessageAdapter extends BaseAdapter {
    ...
    public ChatMessageAdapter(Activity context, List<ChatMessageModel> chatMessages) {
    ...
    private void setAlignment(ViewHolder holder, boolean isMe) {
        if (!isMe) {
            holder.contentWithBG.setBackgroundResource(R.drawable.chat_popup);
